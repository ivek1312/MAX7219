//nalozimo knjiznico s funkcijamu
#include "LedZaslon.h"
...
#define DIN 12 //DIN z zaslona povezemo na pin 12 arduina

#define CHIP_POZICIJA ZGORAJ // moznosti so: LEVO, ZGORAJ, DESNO, SPODAJ
#define SVETLINA_ZASLONA 15 // od 0 do 15

void setup() {
  inicializacija(CS, CLK, DIN, CHIP_POZICIJA, SVETLINA_ZASLONA);
}
